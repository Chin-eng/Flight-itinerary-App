...
CREATE TABLE Users_chinehuu(username VARCHAR(20) PRIMARY KEY,
                           hashedPassword VARBINARY(256) NOT NULL,
                           balance INT NOT NULL);

CREATE TABLE Reservations_chinehuu(res_id INT PRIMARY KEY,
                                   paid INT NOT NULL,
                                   username VARCHAR(20) NOT NULL REFERENCES Users_chinehuu(username),                                  
